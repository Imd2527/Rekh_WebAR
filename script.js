...
/* =====================================================
   SIMPLE HOTSPOT TEST
   Creates ONE clickable hotspot directly on AR screen
===================================================== */

function createTestHotspot() {

  /* Remove old test hotspot if it exists */
  const oldHotspot =
    document.getElementById("testHotspot");
  ...
  hotspot.id = "testHotspot";

  hotspot.innerHTML = "●";


  /* =================================================
     FORCE VISUAL POSITION
  ================================================= */

  hotspot.style.position = "fixed";

  hotspot.style.left = "50%";
  hotspot.style.top = "32%";
  ...
  hotspot.style.width = "52px";
  hotspot.style.height = "52px";
  ...
  hotspot.style.fontSize =
    "25px";

  hotspot.style.fontWeight =
    "bold";

  hotspot.style.display =
    "flex";

  hotspot.style.alignItems =
    "center";

  hotspot.style.justifyContent =
    "center";


  /* =================================================
     FORCE IT ABOVE CAMERA + UI
  ================================================= */

  hotspot.style.zIndex = "99999";
  ...
  hotspot.style.boxShadow =
    "0 0 0 6px rgba(232,189,69,0.25), 0 0 25px rgba(232,189,69,0.8)";
  ...
  console.log(
    "TEST HOTSPOT CREATED"
  );
}


/* =====================================================
   SHOW HOTSPOT WHEN ARTIFACT IS FOUND
===================================================== */
  ...
  function() {
    ...
    target.addEventListener(
      ...
      function() {
        ...
        console.log(
          "VISHNU FOUND → CREATE HOTSPOT"
        );

        /*
           Wait a tiny moment so the
           artifact-found UI is already visible.
        */
